...
const INSTAGRAM = 'https://www.instagram.com/lustrouz_bynzsha/'
    ...
    <footer style={{ background: '#1A1614' }}>
      ...
      >
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-xs tracking-widest uppercase mb-4 sm:mb-5" style={{ color: '#C4A882', letterSpacing: '0.24em' }}>
            Begin Your Journey
          </p>
          <h3
          ...
          >
            Skincare that blends <em style={{ color: '#C4A882', fontStyle: 'italic', fontWeight: 300 }}>science, skill, and subtle luxury.</em>
          </h3>
          <a
            href={BOOKING_URL}
            target="_blank"
            ...
            onMouseEnter={(e) => { e.currentTarget.style.background = '#A8896A'; e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 12px 28px rgba(196,168,130,0.3)' }}
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-14 sm:py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12 items-start">
          ...
          <div className="md:col-span-5 flex flex-col items-start">
            <span className="mb-6 inline-flex" style={{ color: '#FAF7F3' }}>
              <Logo variant="full" size={48} />
            </span>
            <p
              className="font-sans font-light text-sm leading-relaxed max-w-sm"
              style={{ color: 'rgba(250,247,243,0.55)', lineHeight: 1.85 }}
            >
          ...
          <div className="md:col-span-3 flex flex-col gap-3.5">
            <p className="text-xs tracking-widest uppercase font-medium mb-1" style={{ color: '#C4A882', letterSpacing: '0.2em' }}>Navigation</p>
            {navLinks.map((l) => (
              <a
                key={l.label}
                href={l.href}
          ...
          <div className="md:col-span-4">
            <p className="text-xs tracking-widest uppercase font-medium mb-5" style={{ color: '#C4A882', letterSpacing: '0.2em' }}>Visit & Connect</p>

            <div className="text-sm space-y-1 mb-5" style={{ color: 'rgba(250,247,243,0.55)' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(196,168,130,0.12)' }}>
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs" style={{ color: 'rgba(250,247,243,0.35)', letterSpacing: '0.06em' }}>
            © {new Date().getFullYear()} Lustrouz Aesthetics. All rights reserved.
          </p>
          <p className="text-xs" style={{ color: 'rgba(250,247,243,0.25)', letterSpacing: '0.06em' }}>
