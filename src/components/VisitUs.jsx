    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14 sm:mb-16">
          ...
          >
            Visit the <em style={{ color: '#C4A882', fontStyle: 'italic', fontWeight: 300 }}>studio.</em>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start">
          ...
          <div ref={leftRef}>
            ...
            <div className="space-y-7 sm:space-y-8">
              <div>
                <p className="text-xs tracking-widest uppercase mb-2 font-medium" style={{ color: '#C4A882', letterSpacing: '0.2em' }}>Address</p>
                <p className="font-serif text-lg sm:text-xl" style={{ color: '#2C2C2C', fontWeight: 400 }}>1275 Finch Ave W</p>
                <p className="font-serif text-lg sm:text-xl" style={{ color: '#2C2C2C', fontWeight: 400 }}>North York, ON M3J 0L5</p>
                <p className="font-sans text-sm mt-1" style={{ color: '#888' }}>Toronto, Canada</p>
              </div>

              <div>
                <p className="text-xs tracking-widest uppercase mb-3 font-medium" style={{ color: '#C4A882', letterSpacing: '0.2em' }}>Hours</p>
                <div className="space-y-1.5">
                  {[
                    ...
                    <div key={day} className="flex justify-between font-sans text-sm gap-4" style={{ color: '#555' }}>
                      <span>{day}</span>
              ...
              <div>
                <p className="text-xs tracking-widest uppercase mb-3 font-medium" style={{ color: '#C4A882', letterSpacing: '0.2em' }}>Contact</p>
                <a
                  href={INSTAGRAM}
                  target="_blank"
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <a
                  ...
                  style={{ border: '1px solid #C4A882', color: '#C4A882', letterSpacing: '0.14em' }}
                  onMouseEnter={(e) => { e.currentTarget.style.background = '#C4A882'; e.currentTarget.style.color = '#FAF7F3' }}
